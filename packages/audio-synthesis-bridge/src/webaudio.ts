...
export class SynthVoice {
  ...
  /** Mark this prototype voice active; no audio device is opened. */
  noteOn(): void {
    this.active = true;
  }
  ...
  /** Whether this prototype voice is marked active. */
...
export class WebAudioEngine {
  ...
  /** Number of voices marked active; not a measurement of sound output. */
